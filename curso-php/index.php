            ...
            <nav class="modulos">
                ...
                <div class="modulo vermelho">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="exercicio.php?dir=tipos&file=desafio_precedendia">Desafio Precedência</a>
                        </li>
                        <li>
                ...
                <div class="modulo roxo">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="exercicio.php?dir=controle&file=desafio_op_logicos">Desafio Operadores Lógicos</a>
                        </li>                        
                        <li>
                        ...
                        <li>
                            <a href="exercicio.php?dir=controle&file=desafio_switch_2">Desafio Switch 2</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="modulo laranja">
                    ...
                    <ul>
                        <li>
                            <a href="exercicio.php?dir=arrays&file=basico">Array</a>
                        </li>
                    </ul>
                </div>
            </nav>
